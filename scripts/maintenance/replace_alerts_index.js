...
const helperFunction = `
        ...
        function showModalHome(message, title = 'Notification') {
...
// Replace all alert() calls with showModalHome()
const replacements = [
    {
        old: "alert('Please enable location access in your browser settings.');",
        new: "showModalHome('Please enable location access in your browser settings.', 'Location Access Required');"
    },
    {
        old: "alert('Geolocation is not supported by your browser.');",
        new: "showModalHome('Geolocation is not supported by your browser.', 'Feature Not Supported');"
    },
    {
        old: "alert('Please enter valid latitude and longitude values.');",
        new: "showModalHome('Please enter valid latitude and longitude values.', 'Invalid Input');"
    },
    {
        old: "alert('Latitude must be between -90 and 90, Longitude must be between -180 and 180.');",
        new: "showModalHome('Latitude must be between -90 and 90, Longitude must be between -180 and 180.', 'Invalid Coordinates');"
    }
];
...
console.log('✓ Replaced all alert() calls in index.html with showModalHome()');
